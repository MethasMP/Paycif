...
type SignatureService struct {
	...
	udsPath string
	cache   sync.Map
	client  *http.Client // Reused thread-safe HTTP client to prevent connection teardowns and file descriptor leaks.
}
...
func NewSignatureService(db *sql.DB, udsPath string) *SignatureService {
	...
	// Create a shared Transport to enable connection pooling over the Unix Domain Socket.
