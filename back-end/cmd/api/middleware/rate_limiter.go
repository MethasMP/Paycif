...
func RateLimiterMiddleware() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		// Optimized: Direct string concatenation avoids fmt.Sprintf reflection overhead on every HTTP request.
		currentMinute := time.Now().Unix() / 60
...
// SafeCounter is a high-performance thread-safe counter using lock-free atomic operations
