...
func RateLimiterMiddleware() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		// Optimized key formatting using string concatenation and strconv.FormatInt
		// to avoid fmt.Sprintf reflection overhead and excess allocations on hot HTTP paths.
		currentMinute := time.Now().Unix() / 60
