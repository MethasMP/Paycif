...
func RateLimiterMiddleware() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		// Optimized: Replace fmt.Sprintf with direct string concatenation to avoid reflection & heap allocations
		currentMinute := time.Now().Unix() / 60
...
// SafeCounter is a thread-safe counter for memory fallback using lock-free atomic increments
